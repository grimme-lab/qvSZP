...
contains
   subroutine helpf()
      ...
      write(*,'(a35,10x,a)') "--bfile <filename>","# set basis set file location"
      write(*,'(a35,10x,a)') "--efile <filename>","# set ECP file location"
      ...
      write(*,'(a35,10x,a)') "--mpi <int>",       "# set number of MPI processes"
      write(*,'(a35,10x,a)') "--memory <int>",    "# set memory in MB"
      write(*,'(a35,10x,a)') "--defgrid <int>",   "# set grid size"
