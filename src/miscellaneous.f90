...
contains
   subroutine helpf()
      ...
      write(*,'(a35,10x,a)') "--scf-cycles <int>","# set number of SCF cycles. 0 leads to the ORCA default. Default: 125"
      write(*,'(a35,10x,a)') "--notrah",          "# do not use TRAH algorithm for SCF convergence"
